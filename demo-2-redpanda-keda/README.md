...
- low backlog → minimal replicas
- high backlog → scale-out
- drained backlog → gradual scale-down

Scale-down is slower due to:
...
- scaling improves throughput until partition limit is reached
- beyond partition limit, additional replicas provide no benefit

---

## 13) Operational Trade-offs
...
This demo is a focused learning setup, not a production-ready architecture.
